  ...
  return (
    <>
      ...
      <main className="bet_details bg-gray-50 w-full overflow-y-scroll custom-scrollbar">
        <div className="h- p-8 w-full h-auto space-x-6 flex items-start">
          {/* --- */}
          <main className=" w-[100%] space-y-6">
            {/* bet type banner */}
            <div className="bet_banner w-full h-[224px] relative">
              {true ? (
                <Image
          ...
          <aside className=" w-[286px] h-auto sticky top-6">
            {/* ----- */}
            <div className="create_aside border-gray-200 rounded-lg shadow-md bg-white">
              {/* header */}
    ...
    <div className="conditon_card border rounded-lg h-auto">
      ...
      <div className="  p-3" role="button" onClick={handleShowList}>
        <div className="row-between">
          <h1 className="txt-sm f-m text-gray-700">Leicester - Chelsea</h1>
              ...
              .map((i, k) => (
                ...
                >
                  ...
                  <div className="column  space-y-2">
                    <h1 className="f-b txt-sm text-gray-900">1 </h1>

                    <p className="text-gray-400 txt-xs  f-s">HOME</p>
                  </div>
                </li>
              ))}
          </ol>
...
function BetConditionDropdown() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="txt-sm f-m text-gray-500">
          You can select only one condition from each bet sector. Each selection
          counts as the sector point
        </h1>
      ...
      {/* ----footer toggle --- */}
      <div className="card-footer-toggle w-full bg-white row-between p-4 border-t rounded-b-lg px-6">
...
function BetSelectorDetails() {
  ...
  return (
    <div className="conditon_card border rounded-lg  h-auto">
      ...
      <div className=" p-3 " role="button" onClick={handleShowList}>
        <div className="row-between">
          <h1 className="txt-sm f-b text-gray-500">⚽️ Home team / Away team / Draw</h1>
      ...
      {sowList && <div className="w-full border-t rounded-b-xl">
