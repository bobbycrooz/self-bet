							...
							<div className="progress_bar row-between w-full md:px-8 p-4 bg-gray-50 h-[84px] inner_shadow border-t-0  ">
								...
								>
									<Image
										className=""
										src={
											"/images/create/arrow-left.svg"
										}
										alt="arrow"
										width={16}
										height={16}
									/>
									<p className="t-header1">
										back
									</p>
								</div>

								<div className="hidden md:flex match_count capitalize t-headerb7">
									Match Selected
								</div>
	...
	return (
		<>
			<div className="details hidden md:block ">
				<h1 className="md:display-xs txt-xl f-b text-gray-900">
					Select Bet Type
				</h1>

				<p className="subtitle mt-2">
					Please select your desired bet below
				</p>
			</div>
					...
					<div className="absolute w-full h-full linear_g-bet top-0 left-0 p-6 md:p-12 flex items-end md:pb-24 rounded-lg">
						<div className="content w-full space-y-4 ">
							<div className="row-between">
								<h1 className="display-xs md:display-md f-eb md:f-b text-gray-50 capitalize">
									Kolo Bet
								</h1>
							...
							<div className="checks space-y-2 md:space-y-3">
								{fetures.map((i, k) => (
									<div
										key={k}
										className="check-item row  space-x-2"
									>
										<Image
											src={
		...
		<div className="">
			<div className="details ">
				...
				<div className="flex md:hidden row-between">
					<h1 className="md:display-xs f-b text-gray-900">
						Select Match
					</h1>
				...
				<p className="mt-2 txt-xs md:text-[16px] t-g5">
					Please select your desired match below
				</p>
			</div>
			...
			<div className="filter_tab w-full row-between ">
				...
				<div className="hidden lg:flex md:middle space-x-3 nav  txt-sm text-gray-500">
					{nav.map((i, k) => (
						...
						>
							<p className="txt-sm text-gray-500">
								{i}
							</p>
						</div>
					))}
		...
		<>
			<div className="md:flex justify-between">
				<div className="details">
					...
					<p className=" txt-xs t-g6 mt-2 md:subtitle">
					Customize your bets with custom conditiions
					</p>
				</div>
	...
	return (
		<>
			<div className="w-full  h-[600px] overflow-y-scroll custom-scrollbar pb-12">
				<h1 className="txt-xl f-b md:t-header w-full text-left ">
					Bet details
				</h1>
					...
					<div className="details_column mt-4 md:mt-0">
						<div className="space-y-2 md:space-y-1">
							...
							<p className="txt-sm text-gray-400  md:mt-1">
								Add a personal touch. Upload a
								custom banner to represent your
								bet.
							</p>
						</div>
					...
					<div className="details_column mt-6 md:mt-0">
						<div className="space-y-2 md:space-y-1">
							...
							<p className="txt-sm text-gray-400 mt-1 w-[80%]">
								Add a discount to your bet
								participants by paying their
								balance upfront
							</p>
						</div>
