	...
	return (
		<>
			...
			<main className="auth_google w-screen min-h-screen pt-20 md:pb-48">
				<div className="auth_google-card w-[100%]  md:w-[590px] h-auto  mx-auto">
					{handleFlow()}
				</div>
...
function SendReset({
	...
	return (
		<div className="w-full column items-center">
			...
			<h1 className="w-full mt-8  text-center display-xs md:display-sm f-eb text-gray-900">
				Forgot password
			</h1>
	...
	return (
		<div className="w-full column items-center">
			...
			<p className="text-md text-gray-500 mt-3 text-center w-full md:w-[80%]">
				You should choose a new password that you have not used
				before.
			</p>
	...
	return (
		<div className="w-full column space-y-8 items-center ">
			...
			<div className="w-full space-y-2  text-center">
				<h1 className="title display-xs md:display-sm f-eb text-gray-900">
