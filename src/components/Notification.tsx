		...
		<div className="wrapper">
			{isMobile || isTablet ? (
				<div className="betInfo overlay z-[999999999999999999999999999] fixed top-0 flex items-end left-0  w-full h-full bg-[#0000005c]">
					<div
						className={`overlay_pane-mobile info_panel relative w-full fadeIn  ${
							showNoti ? "active" : ""
						}     bg-white`}
					>
						...
						<div className="w-full bg-gray-50 h-[88px] middle px-2 rounded-l-xl">
							<div className="row-between w-full ">
								<div className="space-x-4 middle">
									<Image src={"/icons/notify/noti_bell.svg"} alt={""} width={48} height={48} />

									<h1 className="notify txt-lg f-b text-gray-700  ">Notification</h1>
								</div>
									...
									>
										<div className="space-x-4   flex items-start">
											...
											<div className="noti_text  space-y-1 ">
												<h1 className="notify txt-sm f-b text-gray-700  ">{i.header}</h1>

												<p className="txt-xs f-m text-gray-500 w-[90%]">{i.body}</p>
						...
						<div className="w-full bg-gray-50 h-[88px] middle px-8 rounded-l-xl">
							<div className="row-between w-full ">
								<div className="space-x-4 middle">
									...
									<h1 className="notify txt-xl f-b text-gray-700  ">Notification</h1>
								</div>
									...
									>
										<div className="space-x-6  flex items-start">
											<div className="icon_badge relative">
												...
												<Image src={iconTypeHandler(i.type)} alt={""} width={48} height={48} />
											</div>
